...
def send_message():
	...
	if message == "send_file":
		#client.sendall("recv_file".encode("utf-8"))
		
		attach_message()
		client.sendall("send_file".encode("utf-8"))
	#if message == "recv_file":
		recive_msg()
	if message != "":
...
#recive_msg
#my_btn = tk.Button(bottom_up, text="RecvFile -> .txt", font=BUTTON_FONT, bg=OCEAN_BLUE, fg=WHITE, command=recive_msg)
#my_btn.pack(side=tk.LEFT, padx=5)
